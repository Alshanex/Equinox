...
public class Orb extends CurioBaseItem implements IOrb, IPresetSpellContainer {
    ...
    public Orb(int maxSpellSlots, SpellRarity rarity) {
        this(maxSpellSlots, rarity, ItemPropertiesHelper.equipment().stacksTo(1).rarity(Rarity.UNCOMMON));
    }

    public Orb(int maxSpellSlots, SpellRarity rarity, Properties pProperties) {
        super(pProperties);
