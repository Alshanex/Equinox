...
public class SimpleAttributeOrb extends Orb{
    private final Multimap<Attribute, AttributeModifier> defaultModifiers;

    public SimpleAttributeOrb(int spellSlots, SpellRarity rarity, Attribute attribute, double value) {
        this(spellSlots, rarity, attribute, value, 0);
    }

    public SimpleAttributeOrb(int spellSlots, SpellRarity rarity, Attribute attribute, double value, double mana) {
    ...
    public SimpleAttributeOrb(int spellSlots, SpellRarity rarity, Multimap<Attribute, AttributeModifier> defaultModifiers) {
        super(spellSlots, rarity);
        this.defaultModifiers = defaultModifiers;
    }

    public SimpleAttributeOrb(int spellSlots, SpellRarity rarity, Multimap<Attribute, AttributeModifier> defaultModifiers, Properties properties) {
