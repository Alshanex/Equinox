...
public class CorruptedOrbItem extends UniqueOrb {
    public CorruptedOrbItem(){
        super(SpellRarity.LEGENDARY, SpellDataRegistryHolder.of(
            ...
            builder.put(AttributeRegistry.BLOOD_SPELL_POWER.get(), new AttributeModifier(randomUUID, "Weapon modifier", .03, AttributeModifier.Operation.MULTIPLY_BASE));
            builder.put(AttributeRegistry.BLOOD_MAGIC_RESIST.get(), new AttributeModifier(randomUUID, "Weapon modifier", .03, AttributeModifier.Operation.MULTIPLY_BASE));
            builder.put(AttributeRegistry.HOLY_MAGIC_RESIST.get(), new AttributeModifier(randomUUID, "Weapon modifier", -.50, AttributeModifier.Operation.MULTIPLY_BASE));
            builder.put(AttributeRegistry.LIGHTNING_SPELL_POWER.get(), new AttributeModifier(randomUUID, "Weapon modifier", -.25, AttributeModifier.Operation.MULTIPLY_BASE));
            ...
            builder.put(AttributeRegistry.ELDRITCH_SPELL_POWER.get(), new AttributeModifier(randomUUID, "Weapon modifier", -.25, AttributeModifier.Operation.MULTIPLY_BASE));
            builder.put(AttributeRegistry.FIRE_SPELL_POWER.get(), new AttributeModifier(randomUUID, "Weapon modifier", -.50, AttributeModifier.Operation.MULTIPLY_BASE));
            builder.put(AttributeRegistry.EVOCATION_SPELL_POWER.get(), new AttributeModifier(randomUUID, "Weapon modifier", -.50, AttributeModifier.Operation.MULTIPLY_BASE));
