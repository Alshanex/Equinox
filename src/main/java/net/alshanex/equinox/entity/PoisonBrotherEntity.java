...
public class PoisonBrotherEntity extends NeutralWizard implements IAnimatedAttacker, MagicSummon {
    public PoisonBrotherEntity(EntityType<? extends AbstractSpellCastingMob> pEntityType, Level pLevel) {
    ...
    public PoisonBrotherEntity(Level level, LivingEntity owner, boolean playRiseAnimation) {
        this(EntityRegistry.POISON_BROTHER.get(), level);
        setSummoner(owner);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new SpellBarrageGoal(this, SpellRegistry.POISON_SPLASH_SPELL.get(), 3, 6, 100, 250, 1));
        this.goalSelector.addGoal(3, new GenericAnimatedWarlockAttackGoal<>(this, 1.25f, 50, 75, 3f)
                ...
                .setSpells(
                        List.of(SpellRegistry.ACID_ORB_SPELL.get(), SpellRegistry.POISON_ARROW_SPELL.get(), SpellRegistry.FIREFLY_SWARM_SPELL.get()),
                        List.of(SpellRegistry.OAKSKIN_SPELL.get()),
                        List.of(),
                        List.of(SpellRegistry.ROOT_SPELL.get(), SpellRegistry.BLIGHT_SPELL.get(), SpellRegistry.INVISIBILITY_SPELL.get())
                ).setDrinksPotions()
    ...
    protected void populateDefaultEquipmentSlots(RandomSource pRandom, DifficultyInstance pDifficulty) {
        ...
        this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(ItemRegistry.PLAGUED_LEGGINGS.get()));
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(ItemRegistry.PLAGUED_BOOTS.get()));
    ...
    private final AnimationController<PoisonBrotherEntity> meleeController = new AnimationController<>(this, "keeper_animations", 0, this::predicate);
    ...
    private PlayState predicate(AnimationState<PoisonBrotherEntity> animationEvent) {
